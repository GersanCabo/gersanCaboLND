...
<xsl:stylesheet version="1.0"
    ...
    <!--plantillaparaprocesar el nodo raíz (/) -->
    <xsl:template match="/">        <!--Todo lo que no lleve el prefijo xsl será copiado en lasalida-->
        <html>
            <head>
            ...
            <body>
                ...
                <ul>                    
                    ...
                    <xsl:apply-templates select="//alumno[../@nombre[. = '2º ASIR']]"/>
    ...
    <xsl:template match="alumno">        <!--En esta plantilla transformamos la etiqueta alumno (está dentro de curso)-->
        ...
        Nombre:            <b>
                ...
                <!--salida del texto que está dentro de nombre en negrita--></b>            <!--salida del texto que está dentro de apellidos-->
            <br/>
